...
/****************************************************
 * @init: Инициализации сервера
 * @send_: Отправка сообщения в роли клиента на адрес
 * @working: Бесконечный цикл сервера
 * @get_send_buffer: индентификатор доступа
 * 
****************************************************/
class Network{
public:
    ...
    int send_termin(int port, const char *ip_adr);
    //////////////////////////////////////
    /// Бесконечный цикл сервера
    /////////////////////////////////////
    void working(int* do_work);
protected:
