...
/****************************
 * @pos_lines_in_file: создаёт массив начал строк в файле
 * @parse_file_to_querrys: Возвращает позиции некомментированных строк
 * @any: TEST
 * **************************/
class setup_from_files{
    protected:
        ...
        /**************************************************
         * 
         * \brief создаёт массив указателей на начала строк в файле
         * 
         * 
...
//-------------------------------------------------------------------------
    ...
    /****************************
     * @pos_lines_in_file: создаёт массив поз. начал строк в файле
     * @parse_file_to_querrys: Возвращает позиции некомментированных строк
     * @any: TEST
     * @get_line: возвращает строку по номеру из файла
     * @execute_querry:
     * 
     * **************************/
